...
import 'package:xyloswitch/core/shared/domain/entities/smart_room.dart';
import 'package:xyloswitch/core/shared/presentation/widgets/room_card.dart';
import 'package:xyloswitch/features/smart_room/screens/room_details_screen.dart';
    ...
    return ValueListenableBuilder<double>(
      ...
      builder: (_, page, __) => ValueListenableBuilder(
        ...
        builder: (_, selected, __) => PageView.builder(
          ...
          itemCount: rooms.length + (onAddRoomTap != null ? 1 : 0),
          //itemCount: SmartRoom.fakeValues.length,
          controller: controller,
          itemBuilder: (_, index) {
            if (index == rooms.length && onAddRoomTap != null) {
                    ...
                    await Navigator.push(
                      ...
                      PageRouteBuilder<void>(
                        ...
                        pageBuilder: (_, animation, __) => FadeTransition(
                          opacity: animation,
                          child: ParallaxRoomDetailScreen(room: room),
                        ),
                      ),
                    );
